        ...
        <div className="animate-in slide-in-from-bottom-2 duration-200">
          <div className="bg-muted/50 border rounded-lg p-3 text-sm">
            ...
            <div className="space-y-1 text-xs">
              <div><code className="bg-background px-1 rounded">@reset</code> - Clear conversation history</div>
              <div><code className="bg-background px-1 rounded">@summarize</code> - Summarize our conversation</div>
              <div><code className="bg-background px-1 rounded">@explain [topic]</code> - Get detailed explanation</div>
            </div>
          </div>
        </div>
      )}
